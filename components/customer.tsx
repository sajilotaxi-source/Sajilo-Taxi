...
const BookingPage = ({ locations, availableCars, onBook, trips, onNavigateToAbout, onNavigateToLogin, onNavigateHome }: BookingPageProps) => {
    ...
    const whyChooseUsItems = [
        ...
        { icon: ClockIcon, title: "Easy Booking", text: "Book in seconds with our simple and intuitive interface." },
    ...
    const destinations = [
        ...
        { name: "Kalimpong", image: "https://lh3.googleusercontent.com/d/1dN5u-sg60-bdCFZpp8rXOwExLlrZtSbp" },
